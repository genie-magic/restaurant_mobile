...
class ExpansionTile extends StatefulWidget {
  ...
  /// The color to display the background of the header when expanded
...
class _ExpansionTileState extends State<ExpansionTile>
  ...
  Widget _buildChildren(BuildContext context, Widget child) {
    ...
    final Color headerBackgroundColor = widget.headerBackgroundColor ?? Colors.white;
    final Color headerBackgroundColorExpanded = widget.headerBackgroundColorExpanded ?? Colors.cyan;
